...
let userID = 'caa76646-6563-4125-a01c-06c91851670c';

// https://www.nslookup.io/domains/cdn.xn--b6gac.eu.org/dns-records/
// https://www.nslookup.io/domains/cdn-all.xn--b6gac.eu.org/dns-records/
const proxyIPs= ['cdn.xn--b6gac.eu.org', 'cdn-all.xn--b6gac.eu.org','iplocation.io','japan.com', 'edgetunnel.anycast.eu.org'];
            ...
            if (!upgradeHeader || upgradeHeader !== 'websocket') {
                ...
                switch (url.pathname) {
                    ...
                    default:
                        ...
                        url.hostname = 'www.health365.net';
                        url.protocol = 'https:';
